...
block typ (x,y) size' rotate 
    ...
    |typ=='L' = case rotate of  
        1 ->[(x-size,y,0,1,1,0),(x-size,y+size,0,1,1,0),(x,y+size,0,1,1,0),(x+size,y+size,0,1,1,0)]
        2 -> [(x,y,0,1,1,0),(x,y+size,0,1,1,0),(x,y+size+size,0,1,1,0),(x-size,y+size+size,0,1,1,0)]
        3 -> [(x+size,y +size ,0,1,1,0),(x-size,y,0,1,1,0),(x,y,0,1,1,0),(x+size,y,0,1,1,0)]
        otherwise -> [(x,y,0,1,1,0),(x,y+size,0,1,1,0),(x,y+size+size,0,1,1,0),(x+size,y,0,1,1,0)]
    
    |typ=='J' = case rotate of 
        1 -> [(x+size,y,0,1,0,1),(x+size,y+size,0,1,0,1),(x,y+size,0,1,0,1),(x-size,y+size,0,1,0,1)]
        2 -> [(x,y,0,1,0,1),(x,y+size,0,1,0,1),(x,y+size+size,0,1,0,1),(x-size,y,0,1,0,1)]
        3 -> [(x,y,0,1,0,1),(x-size,y+size,0,1,0,1),(x+size,y,0,1,0,1),(x-size,y,0,1,0,1)]
        otherwise -> [(x,y,0,1,0,1),(x,y+size,0,1,0,1),(x,y+size+size,0,1,0,1),(x+size,y+size+size,0,1,0,1)]
    ...
    |otherwise = [(x,y,0,0.5,0.8,0.1),(x-size,y,0,0.5,0.8,0.1),(x,y-size,0,0.5,0.8,0.1),(x+size,y-size,0,0.5,0.8,0.1),(x+size+size,y-size,0,0.5,0.8,0.1)]
