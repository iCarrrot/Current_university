module Functions (countScore,speedLevel, dropLastTwo, deleteFullRows, unzipTable,updateTable, checkIfEmptyY, checkIfEmptyX,moduloGLfloat, getBlockId, blockSize, makeTable) where
...
unzipTable :: [((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]->[(GLfloat,GLfloat,GLfloat, GLfloat,GLfloat,GLfloat)]
unzipTable [] = []
...
checkIfEmptyY :: [(GLfloat,GLfloat,GLfloat,GLfloat,GLfloat,GLfloat)]->[((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]->GLfloat ->GLfloat
...
checkIfEmptyX :: [(GLfloat,GLfloat,GLfloat,GLfloat,GLfloat,GLfloat)]->[((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]->GLfloat->GLfloat->GLfloat
...
checkIfFull :: [(GLfloat,GLfloat,GLfloat,GLfloat,GLfloat,GLfloat)]->[((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]->GLfloat ->GLfloat
...
checkOne :: (GLfloat,GLfloat,GLfloat,GLfloat,GLfloat,GLfloat) -> [((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]->GLfloat->GLfloat
checkOne (x,y,n3,n4,n5,n6) [] size  
  |x<0.45||x>0.45 = 0
  |y>0.95 = 0  
  |otherwise =(-1)
checkOne (x,y,n1,n2,n3,n4) (((x1,y1),(r1,g1,b1)):table) size
  |absGLfloat (x-x1) < 0.04 && absGLfloat (y-y1) < 0.04 && r1+g1+b1>0 && r1+g1+b1<3 = 1 
  |absGLfloat (x-x1) < 0.04 && absGLfloat (y-y1) < 0.04 && (r1+g1+b1<0.4 || r1+g1+b1>2.6 ) = 0 
...
emptyRow'::GLfloat->GLfloat-> [(GLfloat,GLfloat,GLfloat,GLfloat,GLfloat,GLfloat)]
emptyRow' x y =
      if x<=10 
        then [(x/10 -0.55,y/10-1.05,0,0,0,0)] ++ (emptyRow' (x+1) y)
        else []

deleteFullRows ::[((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]->([((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))],GLfloat)
deleteFullRows table = deleteFullRows' 1 table 0

deleteFullRows' :: GLfloat->[((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]->GLfloat->([((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))],GLfloat)
...
updateTable :: [((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]-> GLfloat-> (GLfloat,GLfloat)->GLfloat-> [((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]
...
updateTable' ((x,y,z,r,g,b):list) (((x1,y1),(r1,g1,b1)):table)
    |absGLfloat (x-x1) < 0.05 && absGLfloat (y-y1) < 0.05 = (updateTable' list (table ++ [((x1,y1),(r,g,b))]))
    |otherwise =   updateTable'  ((x,y,z,r,g,b):list) (table ++ [((x1,y1),(r1,g1,b1))] )

updateTable'' :: [((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))] -> GLfloat -> [((GLfloat,GLfloat),(GLfloat,GLfloat,GLfloat))]
updateTable'' [] y = []
updateTable'' (((x1,y1),(r1,g1,b1)):table) y
  |absGLfloat( y1- (y/10 - 1.05)) < 0.04 =  (updateTable'' table y)++[((x1,0.95),(0,0,0))]
